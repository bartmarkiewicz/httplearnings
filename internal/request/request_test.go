...
func TestRequestLineParse_WrongHttpVersion(t *testing.T) {
	_, err := RequestFromReader(strings.NewReader("PATCH /fish?hahaDoesThisWork=True HTTP/12.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
}

func TestRequestLineParse_NoHttpVersion(t *testing.T) {
	_, err := RequestFromReader(strings.NewReader("POST /fish?hahaDoesThisWork=True \r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
}
